...
const steps = [
  { mood: 'search' as const, title: '找到正好需要的书', text: '按课程、校区、成色与价格组合筛选。' },
  { mood: 'question' as const, title: 'Tobby 帮你快速发布', text: '添加图片和基本信息，一键补全文案。' },
  { mood: 'heart' as const, title: '校内沟通更安心', text: '站内联系，在公共区域当面验书。' }
]
