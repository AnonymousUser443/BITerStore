...
当前本地修复和验收以 [问题修复记录](docs/问题修复记录-2026-09-18.md) 为准；下方历史批次的测试数量和包体数字不是当前值。9 月 18 日修改尚未部署。
...
- [ ] 按授权发布修复版本并应用新增昵称迁移；外部运维和灾备事项继续按交接文档推进。
...
- [x] 实现微信会话、校园认证、商品、图片、搜索、收藏、聊天、举报和治理功能；本次修复尚待发布和真机联调。
