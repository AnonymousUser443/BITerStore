...
export default function NotificationDetailPage() {
  ...
  useEffect(() => { void requireAccount('登录后才能查看通知').then((allowed) => allowed && demoRepository.listNotifications().then((values) => setNotices(values.filter((value) => value.type === type)))) }, [type])
