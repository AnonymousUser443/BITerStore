...
export default function ProfilePage() {
  ...
  return <AppShell title='我的' active='profile' className='profile-page'>
    ...
    <View className='profile-menu'><Text className='menu-title'>账号与安全</Text><MenuButton glyph='refresh' label='退出登录' detail='清除本机的校园认证状态' onClick={async () => { await demoRepository.clearAuthentication(); await navigationAdapter.go('/pages/login/index') }} danger /></View>
  </AppShell>
}
