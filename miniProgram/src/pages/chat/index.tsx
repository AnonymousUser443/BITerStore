...
export default function ChatPage() {
  ...
  const composer = <View className='chat-composer'><Button id='e2e-message-image' onClick={sendImage}><Glyph name='image' /></Button><Button><Glyph name='bookmark' /></Button><Input id='e2e-message-input' value={text} onInput={(event) => setText(event.detail.value)} onConfirm={send} placeholder='输入消息…' /><Button id='e2e-message-send' className='send-button' onClick={send}>发送</Button></View>
