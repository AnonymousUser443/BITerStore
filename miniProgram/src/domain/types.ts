...
export interface User { id: string; studentNumber?: string; name: string; campus: CampusLabel; verified: boolean; wechatBound?: boolean; bio: string; responseTime: string; avatar?: string; avatarTone?: 'sage' | 'peach' | 'blue' | 'gold' | 'olive' }
export interface ProfileUpdate { name: string; campus: CampusLabel; bio: string; avatar?: string }
