...
export interface User { id: string; name: string; campus: Campus; verified: boolean; bio: string; responseTime: string; avatar?: string; avatarTone?: 'sage' | 'peach' | 'blue' | 'gold' | 'olive' }
...
export interface Listing {
  ...
  status: ListingStatus; sellerId: string; createdAt: string; tags: string[]; tone: string; mediaIds: string[]
}
...
export type AppErrorCode = 'STORAGE_READ' | 'STORAGE_WRITE' | 'MEDIA_PICK' | 'MEDIA_PERSIST' | 'VALIDATION' | 'NOT_FOUND'
