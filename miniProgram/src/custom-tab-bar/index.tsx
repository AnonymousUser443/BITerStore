...
const tabs: ReadonlyArray<readonly [string, GlyphName, string, string]> = [['/pages/home/index', 'home', '首页', 'home'], ['/pages/search/index', 'search', '搜索', 'search'], ['/pages/publish/index', 'publish', '发布', 'publish'], ['/pages/messages/index', 'message', '消息', 'messages'], ['/pages/profile/index', 'user', '我的', 'profile']]
